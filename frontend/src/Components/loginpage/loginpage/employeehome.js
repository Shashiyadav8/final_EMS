  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header">
        <p className="text">Welcome {user?.name || 'Employee'}</p>
      ...
      <div className="dashboard-card">
        ...
        <div className="punch-buttons">
          <button onClick={handlePunchIn} disabled={!!status.punch_in}>Punch In</button>
          <button onClick={handlePunchOut} disabled={!status.punch_in || !!status.punch_out}>Punch Out</button>
        </div>
